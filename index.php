...
<body>
   ...
   <header>
      <div class="header-top d-flex justify-content-between align-items-center">
         <div class="logo d-flex">
            ...
            <p class="logo_title align-self-end">Privacy e termini</p>
         </div>
         <div class="user d-flex align-items-center">
            <i class="fas fa-bars"></i>
            <img src="https://lh3.googleusercontent.com/ogw/ADea4I6jy9HwphTSvIJ9u8e1vNj-rDoDBLjLl_G97u8aiEs=s64-c-mo" alt="user foto">
         </div>
      </div>
      <nav>
            ...
            <?php for ($i=0; $i < count($sections); $i++) {?>
               <li>
                  <?php if ($i === count($sections) - 1) {
                     echo "<p class='section active'>{$sections[$i]}</p>";
                  } else {
                     echo "<p class='section'>{$sections[$i]}</p>";
                  } ?>
               </li>
            <?php }?>
         </ul>
   ...
   <main>
      <div class="container">
         ...
         <?php foreach ($faqs as $ask) {?>
            <div class="question">
               <?php 
                  $paragraphs = [];
                  echo "<h3>{$ask['question']}</h3>";
                  foreach ($ask['answers'] as $answer) {
                     $paragraphs = explode('-',$answer);
